 ...
 *
 * THIS FILE IS THE INTERFACE BOUNDARY. Every other module in `apps/web/src/lib/game`
 * and `apps/web/src/components/game` builds against these types. Do not change a shape
