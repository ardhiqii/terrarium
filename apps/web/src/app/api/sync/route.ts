 ...
 *
 * Read `docs/archive/tasks/T28.md`, `docs/archive/tasks/PHASE3.md`, and `apps/web/src/lib/sync/types.ts`
 ...
 * server-side against public GitHub data (see `apps/web/src/lib/game/github.ts`).
 ...
 * `docs/archive/tasks/PHASE3.md`) make that tolerable for now. Nothing in this file may
