...
// Mirrors apps/web/src/lib/game/species-assign.test.ts, ported here because this is
...
describe('resolveVariant (extension copy of apps/web/src/lib/game/variants.ts)', () => {
