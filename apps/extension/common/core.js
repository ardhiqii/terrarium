...
;(function (global) {
  ...
  /**
   * Mirrors `apps/web/src/lib/game/sprites/species.ts` (`SPECIES_LINES`), the Next
   ...
   * docs/archive/tasks/T8.md). Keep in sync by hand if the Next app's line data changes.
  ...
  // Variants (T30)
  //
  // Mirrors `apps/web/src/lib/game/variants.ts` by hand, same reason SPECIES_LINES
  ...
  // apps/web/src/lib/game/variants.ts. A ceiling made `deep` the only variant you
  ...
  /**
   * Mirrors `apps/web/src/lib/game/species-assign.ts`'s FNV-1a hash exactly, so a
